...
<head>
  ...
  <title>Living Boutique | Gestor de Contenidos</title>
...
<div class="wrapper">
  ...
  <header class="main-header">
    ...
    <a href="<?php echo env('PATH_PUBLIC')?>" class="logo">
      ...
      <i class="fa fa-sun-o"></i> Living Boutique</span>
    </a>
      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="active treeview">
          ...
          <ul class="treeview-menu">
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Varietal/2"><i class="fa fa-glass"></i> Varietales</a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Producto/2"><i class="fa fa-list"></i> Productos</a></li>  
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Imagen_de_producto/2"><i class="fa fa-camera"></i> Imagenes de Producto</a></li>   
            <li><a href="<?php echo env('PATH_PUBLIC')?>list/Noticia/2"><i class="fa fa-newspaper-o"></i> Noticias</a></li>  
